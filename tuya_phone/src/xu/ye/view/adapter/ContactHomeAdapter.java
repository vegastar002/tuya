...
import xu.ye.view.other.QuickAlphabeticBar;
...
public class ContactHomeAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.qcbImage = (ImageView) convertView.findViewById(R.id.qcbImage);
...
//		holder.qcbImage.assignContactUri(Contacts.getLookupUri(cb.getContactId(), cb.getLookUpKey()));
		if(0 == cb.getPhotoId()){
			holder.qcbImage.setImageResource(R.drawable.app_panel_friendcard_icon2);
		}else{
			...
			holder.qcbImage.setImageBitmap(contactPhoto);
		}
