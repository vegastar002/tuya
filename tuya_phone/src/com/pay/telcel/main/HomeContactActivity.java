...
import xu.ye.view.other.MenuHorizontalScrollView;
	...
	private void setAdapter(List<ContactBean> list) {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent intentMainActivity = new Intent(HomeContactActivity.this, OutgoingActivity.class);
				intentMainActivity.putExtra("number", cb.getPhoneNum());
